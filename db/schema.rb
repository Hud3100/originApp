...
ActiveRecord::Schema.define(version: 2020_07_04_083104) do
  ...
  create_table "micropost_category_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
